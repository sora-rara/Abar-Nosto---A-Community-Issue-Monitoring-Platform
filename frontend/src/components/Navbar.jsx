            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center">
                        <Link to={isLoggedIn ? (isAdmin ? "/admin/issues" : "/dashboard") : "/login"} className="flex items-center space-x-2">
                    ...
                    <div className="hidden md:block">
                        <div className="flex items-center space-x-4">
                            {isLoggedIn ? (
                                <>
                                    {/* Dashboard link – hidden for admin */}
                                    {!isAdmin && (
                                        <Link
                                            to="/dashboard"
                                    ...
                                    {/* Admin Issues link – only for admin */}
                                    {isAdmin && (
                                        <Link
                                            to="/admin/issues"
                    ...
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        {isLoggedIn ? (
                            <>
                                ...
                                {/* Dashboard link in mobile – hidden for admin */}
                                {!isAdmin && (
                                    <Link
                                        to="/dashboard"
                                ...
                                {/* Admin Issues link in mobile – admin only */}
                                {isAdmin && (
                                    <Link
                                        to="/admin/issues"
